...
export WORK_DIR=/home/dpc/syb/syb_carla_garage_v251013/carla_garage/Bench2Drive
export PROJECT_ROOT=/home/dpc/syb/syb_carla_garage_v251013/carla_garage
...
CHECKPOINT_ENDPOINT="${WORK_DIR}/${ALGO}_b2d_${PLANNER_TYPE}/${BASE_CHECKPOINT_ENDPOINT}.json"
mkdir -p "${WORK_DIR}/${ALGO}_b2d_${PLANNER_TYPE}"
GPU_RANK=0
