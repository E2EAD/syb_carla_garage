...
TEAM_CONFIG=${PROJECT_ROOT}/log/syb_train_noMoe_4-gw
...
RESULT_PATH=noMoe_eb-ts-m-ot-gw  # 'No_Scenario','Give_Way', 'Overtaking', 'Merging', 'Traffic_Sign', 'Emergency_Brake'
...
for ((i=0; i<$length; i++ )); do
      ...
      CHECKPOINT_ENDPOINT="${WORK_DIR}/${RESULT_PATH}/${BASE_CHECKPOINT_ENDPOINT}_${TASK_LIST[$i]}.json"
