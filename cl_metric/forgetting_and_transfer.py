...
if __name__ == '__main__':
    # 假设您已经将表格读取为numpy数组
    # skill_matrix = [[6.65,2.22,6.27,0,13.68],
    #                 [14.1,0,10,20,20.74],
    #                 [20,11.1,10,30,22.63],
    #                 [13.75,13.33,5,30,11.05],
    #                 [13.75,8.89,6.67,40,25.26]]
    skill_matrix = [[38.75,17.76,73.33,50,66.84],
                    [48.75,11.11,73.33,50,77.89],
                    [47.5,24.44,60,50,72.11],
                    [5,44.44,33.33,50,64.74],
                    [30,24.44,23.33,50,41.05]]
