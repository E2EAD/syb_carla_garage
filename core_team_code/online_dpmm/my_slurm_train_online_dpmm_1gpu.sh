...
# =====================================================================
# SLURM script for online alternating Network-DPMM training (1 GPU).
#
# Usage:
#   sbatch core_team_code/online_dpmm/my_slurm_train_online_dpmm_1gpu.sh
#
...
CMD="torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=0 --rdzv_id=\$SLURM_JOB_ID --rdzv_backend=c10d \
  ...
  --logdir ${LOGDIR} \
  --use_controller_input_prediction 1 --use_wp_gru 0 --continue_epoch 0 --cpu_cores 8 \
