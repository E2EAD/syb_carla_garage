...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=1 --rdzv_id=251030 --rdzv_backend=c10d \
    team_code/my_train_ability_moe_v0.py --id syb_train_demo_1-ts_moev0 --use_disk_cache 0 --crop_image 1 --seed 0 --epochs 31 --batch_size 2 --lr 3e-4 --setting all \
    --root_dir /home/syb/b2d_mini_v2 \
    --logdir ${PROJECT_ROOT}/log \
    ...
    --image_architecture regnety_032 --lidar_architecture regnety_032 --load_file ${PROJECT_ROOT}/log/syb_train_demo_0-eb_moev0/model_0030.pth

# --load_file ${PROJECT_ROOT}/log/syb_train_demo_0-eb_moev3/model_0005.pth