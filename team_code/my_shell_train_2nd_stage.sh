...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=1 --rdzv_id=251121 --rdzv_backend=c10d \
    team_code/my_train_ability_moe_v04.py --id syb_train_demo_0-eb_fast_moev04 --use_disk_cache 0 --crop_image 1 --seed 0 --epochs 31 --batch_size 2 --lr 3e-4 --setting all \
    --root_dir /home/syb/b2d_mini_v2 \
    --logdir ${PROJECT_ROOT}/log \
