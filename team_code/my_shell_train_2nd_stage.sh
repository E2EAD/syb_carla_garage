...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=1 --rdzv_id=syb_train_250930_1600_2stg --rdzv_backend=c10d \
    team_code/my_train.py --id syb_train_250930_1600_2stg --use_disk_cache 0 --crop_image 1 --seed 0 --epochs 31 --batch_size 2 --lr 3e-4 --setting all \
    --root_dir /home/syb/b2d_mini_v2 \
    --logdir ${PROJECT_ROOT}/log \
    ...
    --image_architecture regnety_032 --lidar_architecture regnety_032 --load_file ${PROJECT_ROOT}/log/syb_train_250930_1600/model_0030.pth
