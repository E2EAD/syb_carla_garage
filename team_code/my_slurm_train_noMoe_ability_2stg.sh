...
torchrun --nnodes=1 --nproc_per_node=4 --max_restarts=0 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    team_code/my_train_ability.py --id syb_train_noMow_0-eb --use_disk_cache 0 --crop_image 1 --seed 0 --epochs 31 --batch_size 16 --lr 3e-4 --setting all \
...
# --load_file /share/home/u19666033/syb/carla_garage/log/syb_train_noMow_0-eb/model_0030.pth
